...
VERSION:3.0
N:Mamedov;Idris;;;
FN:Мамедов Идрис Мадиддиоглы
ORG:ToraBika
TITLE:Руководитель отдела продаж по ключевым клиентам
TEL;TYPE=CELL,VOICE:+77015643331
EMAIL;TYPE=INTERNET:mamedov.i@prestij.kz
  ...
  <main class="card-page" role="main">
    <section class="hero">
      <div style="display: flex; justify-content: center; align-items: center; gap: 10px; flex-wrap: wrap;">
        <img src="../public/logo(kolominsky).png" alt="Company Logo" style="width: min(250px, 30vw); height: auto; margin-top: 10px;">
        <img src="../public/logo(torabika).png" alt="Company Logo" style="width: min(150px, 30vw); height: auto; margin-top: 10px;">
      </div>
      <h1 class="name">Мамедов Идрис Мадиддиоглы</h1>
      <div class="too">TOO "Prestiage DA (Престиж ДА)"</div>
      <p class="subtitle">Руководитель отдела продаж по ключевым клиентам</p>
    </section>
    ...
    <nav class="actions" aria-label="Действия">
      ...
      <!-- 2) WhatsApp -->
      <a class="btn" href="https://wa.me/77015643331" target="_blank" rel="noopener" aria-label="Открыть WhatsApp">
        <span class="ico" aria-hidden="true">
      ...
      <!-- 3) Telegram -->
      <a class="btn" href="https://t.me/+77015643331" target="_blank" rel="noopener" aria-label="Открыть Telegram">
        <span class="ico" aria-hidden="true">
